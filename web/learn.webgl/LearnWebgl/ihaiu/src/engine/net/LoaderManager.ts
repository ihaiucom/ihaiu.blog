...
//      */
//     load(url: string|string[]|loadItem[], complete: Handler|null = null, progress: Handler|null = null, type: string|null = null, priority: number = 1, cache: boolean = true, group: string|null = null, ignoreCache: boolean = false, useWorkerLoader: boolean = false): LoaderManager {
//         if (url instanceof Array) {
...
//             Engine.systemTimer.frameOnce(1, this, function (this:LoaderManager): void {
//                 progress && progress.runWith(1);
...
//                 Engine.systemTimer.once(this.retryDelay, this, this._addReTry, [resInfo], false);
//                 return;
//             } else {
