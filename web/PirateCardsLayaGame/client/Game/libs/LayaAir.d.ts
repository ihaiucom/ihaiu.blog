...
declare module laya.d3.component {
	...
	class PostProcess  {
		 ...
		 * 设置屏幕颜色
		 */
		setScreenColor(iscolor:boolean);
		/**
		 * 添加后期处理效果。
		 */
...
declare module laya.webgl {
	...
	declare class Laya  {
		...
		static MiniFileManager: any;
        static CameraClearFlags: any;
		/**
		 * 舞台对象的引用。
		 */
