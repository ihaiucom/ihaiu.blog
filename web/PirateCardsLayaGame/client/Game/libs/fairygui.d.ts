...
declare namespace fgui {
    class GLoader extends GObject {
        ...
        protected createDisplayObject(): void;
        dispose(): void;
        drawTextureColor(color: string, alpha: number)
        url: string;
        icon: string;
        align: string;
        verticalAlign: string;
...
declare namespace fgui {
    class DragDropManager {
        ...
        readonly dragging: boolean;
        startDrag(sourc: GObject, sourceData: any, touchPointID?: number): void;
        onDrop(source: GObject, caller: GObject, callback: Function): void;
        offDrop(source: GObject, caller: GObject, callback: Function): void;
        cancel(): void;
