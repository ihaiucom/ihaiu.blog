...
import EnterModuleLoader from "../../FGUI/Extends/GameLaunch/EnterModuleLoader";


//======================
// 加载界面--进入游戏
//----------------------
export default class LoaderEnterModelPanel extends LoaderPanel
{
    loader: EnterModuleLoader;
    tips: string[] = [];
