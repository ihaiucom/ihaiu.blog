...
import EnterLoginLoader from "../../FGUI/Extends/GameLaunch/EnterLoginLoader";


//======================
// 加载界面--进入游戏
//----------------------
export default class LoaderEnterLoginPanel extends LoaderPanel
{
    loader: EnterLoginLoader;
    tips: string[] = [];
