...
export default class MenuManager
{
    ...
    // 打开模块
    async openAsync(menuId: MenuId, ...args: any[]): Promise<MenuCtl> 
    {
        ...
        {
            return new Promise<MenuCtl>((resolve)=>
            {
                ctl.sOpen.addOnce(()=>
                {
                    resolve(ctl);
    ...
    __onMenuClose(ctl: MenuCtl)
    {
        ...
        var isNeedOpenHome: boolean = moduleOpenedNum == 0;
        if(isNeedOpenHome)
        {
