...
import SecretBookListWindowUI from '../../FGUI/Extends/ModuleSecretBook/SecretBookListWindowUI';


export default class SecretBookListWindow extends MWindow
{
    window: SecretBookListWindowUI;
    constructor()
    {
        super();

        // 添加依赖资源
        this.addAssetForFguiComponent(SecretBookListWindowUI);
    ...
    {
        let windowUI = SecretBookListWindowUI.createInstance();
