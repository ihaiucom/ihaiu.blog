...
import SecretLandAffixWindowUI from '../../FGUI/Extends/ModuleSecretLand/SecretLandAffixWindowUI';


export default class SecretLandAffixWindow extends MWindow
{
    window: SecretLandAffixWindowUI;
    constructor()
    {
        super();

        // 添加依赖资源
        this.addAssetForFguiComponent(SecretLandAffixWindowUI);
    ...
    {
        let windowUI = SecretLandAffixWindowUI.createInstance();
