...
export default class FguiHelper
{
    ...
    //-------------------------
    static setChildWindow(com: fgui.GComponent, window: MWindow)
    {
        if (com)
        {
            ...
            if (com._children)
            {
                ...
                {
                    this.setChildWindow(<fgui.GComponent>com._children[i], window);
                }
            }
        }
    }
    ...
    //-------------------------
    static callChildOnWindowInited(com: fgui.GComponent)
    {
        if (com)
        {
            ...
            if (com._children)
            {
                for (let i = 0; i < com._children.length; i++)
                {
                    this.callChildOnWindowInited(<fgui.GComponent>com._children[i]);
                }
            }
        }
    }
    ...
    //-------------------------
    static callChildOnWindowDestory(com: fgui.GObject)
    {
        ...
        if (com)
        {
            ...
            {
                let display = <Laya.Sprite>container.getChildAt(i);
                if (display["$owner"])
    ...
    //-------------------------
    static callChildOnWindowShow(com: fgui.GComponent)
    {
        if (com)
        {
            ...
            if (enbaleCall && com._children)
            {
                ...
                {
                    this.callChildOnWindowShow(<fgui.GComponent>com._children[i]);
                }
            }
        }
    }
    ...
    //-------------------------
    static callChildOnWindowHide(com: fgui.GComponent)
    {
        if (com)
        {
            let enbaleCall: boolean = true;
            ...
            if (enbaleCall && com._children)
            {
                for (let i = 0; i < com._children.length; i++)
                {
                    this.callChildOnWindowHide(<fgui.GComponent>com._children[i]);
                }
            }
        }
    }
    ...
    //-------------------------
    static callChildOnTabShow(com: fgui.GObject)
    {
        if (com)
        {
    ...
    //-------------------------
    static callChildOnTabHide(com: fgui.GObject)
    {
        if (com)
        {
	...
	// 屏幕自适应
	static autoScreenScaleShrink(content: fgui.GObject, alignH?: string, alignV?: string)
	{
	...
	// 屏幕自适应
	static autoScreenScaleShrink2(content: fgui.GObject, sourceScale: number = 1)
	{
	...
	// 屏幕自适应
	static autoScreenScale(content: fgui.GObject, alignH?: string, alignV?: string)
	{
	...
	// 屏幕自适应
	static autoScreenScale2(content: fgui.GObject)
	{
		let rate = Game.screenSetting.screenScaleExpand;
	...
	// 屏幕自适应
	static autoScreenScale3(content: fgui.GObject)
	{
		let rate = Game.screenSetting.screenScaleExpand;
	...
	// 屏幕自适应 场景大小
	static autoScreenSize(content: fgui.GObject, alignH?: string, alignV?: string)
	{
		let rate = Game.screenSetting.screenScaleExpand;
	...
	// 屏幕自适应 -- 父容器大小
	static autoParentSize(content: fgui.GObject, alignH?: string, alignV?: string)
	{
		let rate = Game.screenSetting.screenScaleExpand;
	...
	// 屏幕大小
	static setScreenSize(content: fgui.GObject)
	{
	...
	{
		//let txtmap = fgui.UIPackage["_stringsSource"] = {};
	...
	static setGray(component: fgui.GObject)
	{
		if (!component)
			return;
	...
	static clearFilters(component: fgui.GObject)
	{
		if (!component)
			return;
	...
	static halfStaturation(obj: fgui.GObject)
	{
		if (!obj)
			return;
	...
	static half2Staturation(obj: fgui.GObject)
	{
		if (!obj)
			return;
	...
	static half3Staturation(obj: fgui.GObject)
	{
		if (!obj)
			return;
	...
	//组件弹出效果
	static boundEffect(target: fgui.GObject, duration: number = 1000)
	{
