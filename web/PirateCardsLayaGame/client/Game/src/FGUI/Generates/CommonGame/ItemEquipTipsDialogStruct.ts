...
export default class ItemEquipTipsDialogStruct extends fgui.GComponent
{
	...
	public static URL:string = "ui://4snov4n9lfxi30";
	
	public static DependPackages:string[] = ["CommonGame","CommonBase","ModuleHero"];

	
	public static createInstance():ItemEquipTipsDialog {
		return <ItemEquipTipsDialog><any>(fgui.UIPackage.createObject("CommonGame","ItemEquipTipsDialog"));
	}
