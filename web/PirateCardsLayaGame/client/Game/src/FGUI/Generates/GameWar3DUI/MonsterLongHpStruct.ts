...
export default class MonsterLongHpStruct extends fgui.GComponent
{
	...
	public static URL:string = "ui://yhpe9txzq91pcz";
	
	public static DependPackages:string[] = ["GameWar3DUI"];

	
	public static createInstance():MonsterLongHp {
		return <MonsterLongHp><any>(fgui.UIPackage.createObject("GameWar3DUI","MonsterLongHp"));
	}
