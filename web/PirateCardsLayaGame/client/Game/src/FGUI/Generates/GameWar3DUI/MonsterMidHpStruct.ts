...
export default class MonsterMidHpStruct extends fgui.GComponent
{
	...
	public static URL:string = "ui://yhpe9txzq91pd0";
	
	public static DependPackages:string[] = ["GameWar3DUI"];

	
	public static createInstance():MonsterMidHp {
		return <MonsterMidHp><any>(fgui.UIPackage.createObject("GameWar3DUI","MonsterMidHp"));
	}
