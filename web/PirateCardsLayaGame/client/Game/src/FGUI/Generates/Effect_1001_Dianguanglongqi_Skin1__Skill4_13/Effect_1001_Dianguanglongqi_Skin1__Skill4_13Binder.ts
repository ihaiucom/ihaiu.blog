...
export default class Effect_1001_Dianguanglongqi_Skin1__Skill4_13Binder
{
	public static bindAll():void 
	{
		let bind = fgui.UIObjectFactory.setPackageItemExtension;
		bind(Effect_1001_Dianguanglongqi_Skin1__Skill4_13.URL, Effect_1001_Dianguanglongqi_Skin1__Skill4_13);
	}
}