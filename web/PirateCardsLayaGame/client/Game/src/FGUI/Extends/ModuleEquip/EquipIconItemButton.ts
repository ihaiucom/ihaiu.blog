...
import EquipIconItemButtonStruct from "../../Generates/ModuleEquip/EquipIconItemButtonStruct";
import { EquipData } from "../../../GameModule/DataStructs/EquipData";
import Game from "../../../Game";

export default class EquipIconItemButton extends EquipIconItemButtonStruct
{
    itemData: EquipData;
