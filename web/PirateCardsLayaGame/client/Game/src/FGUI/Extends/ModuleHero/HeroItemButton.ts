...
import HeroItemButtonStruct from "../../Generates/ModuleHero/HeroItemButtonStruct";
import { HeroData } from "../../../GameModule/DataStructs/HeroData";
import Game from "../../../Game";
import GameEventKey from "../../../GameEventKey";

export enum BattleItemSelectIndex
{
    default = 0,
    dowm,
}

export default class HeroItemButton extends HeroItemButtonStruct
{
    itemData:HeroData;
    index: number;
