...
import WindowHead2Struct from "../../Generates/CommonGame/WindowHead2Struct";
import Game from "../../../Game";
import {Mawait} from "../../../GameWar/Logic/Utils/Mawait";
import {MenuId} from "../../../GameModule/MenuId";
import GameEventKey from "../../../GameEventKey";
import WindowHeadItem2 from './WindowHeadItem2';
import GamerNotifyFatigueS2C = proto.GamerNotifyFatigueS2C;

export default class WindowHead2 extends WindowHead2Struct
{
    private MenuId: number;

    private lastTab: number;

    private itemList: WindowHeadItem2[] = [];

    /*----------------------默认视图接口---------------------------*/
    /** 窗口初始化完毕 */
    onWindowInited(): void
    {
        this.itemList = [this.m_fatigue,this.m_coin,this.m_gold,this.m_draug, this.m_roll];
    }
    ...
    onWindowShow(): void
    {
        ...
        this.m_roll.onClick(this,this.OpenRoll);
        ...
        Game.net.gamerBuyRollS2C.on(this.GamerBuyRollS2C,this);
    ...
    onWindowHide(): void
    {
        ...
        this.m_roll.offClick(this,this.OpenRoll);
        ...
        Game.net.gamerBuyRollS2C.off(this.GamerBuyRollS2C,this);
    ...
    private OpenRoll()
    {
        Game.menu.open(Number(this.m_roll.title));
    }
    ...
    private UpdateRoll()
    {
        ...
        if(config && config.topInformation.length && config.topInformation.indexOf(Number(this.m_roll.title)) != -1)
        {
            let model = Game.moduleModel.secretLand;
            this.m_roll.m_labNum.text = model.rollNum + "/" + model.maxRollNum;
            let page = model.rollNum >= model.maxRollNum ? "NO": "OK"
            this.m_roll.m_Add.setSelectedPage(page);
        }
    }
