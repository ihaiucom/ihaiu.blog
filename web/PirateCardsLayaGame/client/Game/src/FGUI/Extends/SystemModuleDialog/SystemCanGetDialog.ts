...
import SystemCanGetDialogStruct from "../../Generates/SystemModuleDialog/SystemCanGetDialogStruct";
...
export default class SystemCanGetDialog extends SystemCanGetDialogStruct
{
    ...
    private UpdateView(text:string)
    {
        ...
        this.m_labShow.text = text ? text : "";
    }

    /*public----------------------外部接口---------------------------*/
    /** 打开弹框 */
    open(itemdatas:ItemData[] | IGameItem[], text:string)
    {
