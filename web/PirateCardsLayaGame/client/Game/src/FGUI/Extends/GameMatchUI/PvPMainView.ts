...
import PvPMainViewStruct from "../../Generates/GameMatchUI/PvPMainViewStruct";
import TimeHelper from "../../../GameHelpers/TimeHelper";
import Game from "../../../Game";
import { MenuId } from "../../../GameModule/MenuId";
import MatchWindowUI from "./MatchWindowUI";

export default class PvPMainView extends PvPMainViewStruct
{
    ...
    onWindowShow(): void
    {
        ...
        if (windowUI.m_state.selectedIndex != PvPMainView.PAGE) 
        {
            return;
        }
    ...
    StartAndCancelMatch()
    {
        if (!this._match) {
            ...
            // Game.sender.battleMatch.matchStart(proto.PVPType.PVP_M1V1, 0);
        } else {
            this._match = false;
            this.m_btnMatch.title = "开始";
