...
import P2vP2MainViewStruct from "../../Generates/GameMatchUI/P2vP2MainViewStruct";
import TimeHelper from "../../../GameHelpers/TimeHelper";
import Game from "../../../Game";
import { MenuId } from "../../../GameModule/MenuId";
import MatchWindowUI from "./MatchWindowUI";

export default class P2vP2MainView extends P2vP2MainViewStruct
{
    ...
    onWindowShow(): void
    {
        ...
        if (windowUI.m_state.selectedIndex != P2vP2MainView.PAGE) 
        {
            return;
        }
    ...
    StartAndCancelMatch()
    {
        if (!this._match) {
            ...
            // Game.sender.battleMatch.matchStart(proto.PVPType.PVP_M2V2, 0);
        } else {
            this._match = false;
            this.m_btnMatch.title = "开始";
