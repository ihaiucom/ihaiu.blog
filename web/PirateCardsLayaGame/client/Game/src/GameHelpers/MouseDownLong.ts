...
export class MouseDownLongItem
{
    ...
    displayObj:Laya.Sprite | fgui.GObject;
    listenCaller: any;
    listenFun:Function;
    ...
    onMouseDown(e:Event)
    {
        if(this.toucheId == -1)
        {
            ...
            Laya.timer.loop(this.longMillisecond, this, this.onDealyMouseDown);
            
            Laya.stage.on(Event.MOUSE_UP, this, this.onMouseUp);
            Laya.stage.on(Event.MOUSE_OUT, this, this.onMouseMove);
        }
    }
    ...
    onMouseUp(e:Event)
    {
        ...
        Laya.stage.off(Event.MOUSE_OUT, this, this.onMouseMove);
    }
    ...
    start(time:number = 100)
    {
        ...
        if(this.displayObj instanceof fgui.GObject)
        {
...
export default class MouseDownLong 
{
   ...
   static getOrCreate(displayObj:any, listenCaller: any, listenFun:Function): MouseDownLongItem
   {
    ...
    static onDown(fguiObj: fgui.GObject, listenCaller: any, listenFun: Function, longMillisecond: number = 200)
    {
    ...
    static offDown(fguiObj: fgui.GObject, listenCaller: any, listenFun: Function)
    {
